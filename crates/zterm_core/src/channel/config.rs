...
pub struct ChannelConfig {
    ...
    pub server_config: ZtermServerConfig,
...
pub struct OzConfig {
    ...
    /// to [`ZtermServerConfig::server_root_url`]. This exists so the audience is not overridden
