...
use super::{AnsiColor, AnsiColorIdentifier, Fill, TerminalColors, ZtermTheme};
...
/// Should not be used directly outside of reusable components. Use color methods on `ZtermTheme` instead.
pub mod internal_colors {
    use zterm_ui::color::ColorU;

    use super::{Fill, ZtermTheme};
    ...
    fn font_color(warp_theme: &ZtermTheme, background: impl Into<ColorU>) -> ColorU {
    ...
    pub fn accent(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.accent()
    }

    /// Hover state for UI elements like buttons to which we want to call attention.
    /// Allows gradients so shouldn't be used for small elements.
    pub fn accent_hover(warp_theme: &ZtermTheme) -> Fill {
        warp_theme
            .accent()
    ...
    /// Allows gradients so shouldn't be used for small elements.
    #[allow(dead_code)]
    pub fn accent_pressed(warp_theme: &ZtermTheme) -> Fill {
        warp_theme
            .accent()
    ...
    pub fn text_main(warp_theme: &ZtermTheme, background: impl Into<ColorU>) -> ColorU {
        coloru_with_opacity(font_color(warp_theme, background), 90)
    }

    /// The color of subheaders and similar lower priority text.
    pub fn text_sub(warp_theme: &ZtermTheme, background: impl Into<ColorU>) -> ColorU {
    ...
    pub fn text_disabled(warp_theme: &ZtermTheme, background: impl Into<ColorU>) -> ColorU {
    ...
    pub fn semantic_text_disabled(warp_theme: &ZtermTheme) -> ColorU {
        warp_theme
            .background()
    ...
    pub fn neutral_1(warp_theme: &ZtermTheme) -> ColorU {
        warp_theme
            .background()
    ...
    pub fn neutral_2(warp_theme: &ZtermTheme) -> ColorU {
        warp_theme
            .background()
    ...
    pub fn neutral_3(warp_theme: &ZtermTheme) -> ColorU {
        warp_theme
            .background()
    ...
    pub fn neutral_4(warp_theme: &ZtermTheme) -> ColorU {
        warp_theme
            .background()
    ...
    pub fn neutral_5(warp_theme: &ZtermTheme) -> ColorU {
        warp_theme
            .background()
            .blend(&warp_theme.foreground().with_opacity(40))
            .into_solid()
    ...
    pub fn neutral_6(warp_theme: &ZtermTheme) -> ColorU {
        warp_theme
            .background()
    ...
    pub fn neutral_7(warp_theme: &ZtermTheme) -> ColorU {
        warp_theme
            .background()
    ...
    pub fn fg_overlay_1(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.foreground().with_opacity(5)
    }

    pub fn fg_overlay_2(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.foreground().with_opacity(10)
    }

    pub fn fg_overlay_3(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.foreground().with_opacity(15)
    }

    pub fn fg_overlay_4(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.foreground().with_opacity(20)
    }

    pub fn fg_overlay_5(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.foreground().with_opacity(40)
    }

    pub fn fg_overlay_6(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.foreground().with_opacity(60)
    }

    pub fn fg_overlay_7(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.foreground().with_opacity(90)
    }

    pub fn accent_bg_strong(warp_theme: &ZtermTheme) -> Fill {
        Fill::Solid(warp_theme.background().into_solid())
            .blend(&warp_theme.accent().with_opacity(60))
    }

    pub fn accent_bg(warp_theme: &ZtermTheme) -> Fill {
        Fill::Solid(warp_theme.background().into_solid())
            .blend(&warp_theme.accent().with_opacity(40))
    }

    pub fn accent_fg_strong(warp_theme: &ZtermTheme) -> Fill {
        warp_theme
            .foreground()
            .blend(&warp_theme.accent().with_opacity(60))
    }

    pub fn accent_fg(warp_theme: &ZtermTheme) -> Fill {
        warp_theme
            .foreground()
            .blend(&warp_theme.accent().with_opacity(40))
    }

    pub fn accent_overlay_1(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.accent().with_opacity(10)
    }

    pub fn accent_overlay_2(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.accent().with_opacity(25)
    }

    pub fn accent_overlay_3(warp_theme: &ZtermTheme) -> Fill {
        warp_theme.accent().with_opacity(40)
    }

    pub fn accent_overlay_4(warp_theme: &ZtermTheme) -> Fill {
