...
use zterm_ui::{assets::asset_cache::AssetSource, color::ColorU, geometry::vector::vec2f};
...
impl From<Fill> for zterm_ui::elements::Fill {
    fn from(theme: Fill) -> Self {
        match theme {
            Fill::Solid(c) => zterm_ui::elements::Fill::Solid(c),
            Fill::HorizontalGradient(g) => zterm_ui::elements::Fill::Gradient {
                start: vec2f(0.0, 0.0),
                end: vec2f(1.0, 0.0),
                start_color: g.left,
                end_color: g.right,
            },
            Fill::VerticalGradient(g) => zterm_ui::elements::Fill::Gradient {
                start: vec2f(0.0, 0.0),
                end: vec2f(0.0, 1.0),
                start_color: g.top,
                end_color: g.bottom,
