...
/// Icon enum to be used within the app in place of the zterm_ui::elements::Icon directly. It
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::ZtermDrive => "bundled/svg/warp.svg",
...
impl Icon {
    ...
    pub fn icon_for_key(key: &str) -> Option<WarpUiIcon> {
        match key {
            "⏎" => Some(Self::CornerDownLeft.to_zterm_ui_icon(Fill::black())),
            _ => None,
        }
    }
}
