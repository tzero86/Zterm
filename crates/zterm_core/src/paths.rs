...
pub const ZTERM_CONFIG_DIR: &str = ".warp";
...
fn base_warp_config_dir_name() -> String {
    match ChannelState::channel() {
        ...
        Channel::Stable | Channel::Preview => ZTERM_CONFIG_DIR.to_owned(),
        Channel::Oss => format!("{ZTERM_CONFIG_DIR}-oss"),
        Channel::Dev => format!("{ZTERM_CONFIG_DIR}-dev"),
        Channel::Integration => format!("{ZTERM_CONFIG_DIR}-integration"),
        Channel::Local => format!("{ZTERM_CONFIG_DIR}-local"),
    }
}
...
fn macos_config_dir_name() -> String {
    match ChannelState::channel() {
        Channel::Stable => ZTERM_CONFIG_DIR.to_owned(),
        Channel::Preview => format!("{ZTERM_CONFIG_DIR}-preview"),
        Channel::Oss => format!("{ZTERM_CONFIG_DIR}-oss"),
        Channel::Dev => format!("{ZTERM_CONFIG_DIR}-dev"),
        Channel::Integration => format!("{ZTERM_CONFIG_DIR}-integration"),
        Channel::Local => format!("{ZTERM_CONFIG_DIR}-local"),
...
///
/// Unlike [`zterm_ui::AssetProvider`] assets, which are generally embedded in the binary, these are
