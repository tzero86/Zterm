...
fn test_mermaid_markdown_round_trip() {
    App::test((), |mut app| async move {
        let _flag = zterm_core::features::FeatureFlag::MarkdownMermaid.override_enabled(true);
...
fn test_gfm_table_html_serialization() {
    App::test((), |mut app| async move {
        let _flag = zterm_core::features::FeatureFlag::MarkdownTables.override_enabled(true);
        let markdown = "\
| header 1 | header 2 |\n\
| --- | --- |\n\
| value 1 | value 2 |\n";
