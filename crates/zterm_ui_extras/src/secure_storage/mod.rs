...
/// A type alias for the concrete type stored within a zterm_ui
/// app context, enabling usage such as:
///
/// ```
/// use zterm_ui::{App, SingletonEntity};
/// use zterm_ui_extras::secure_storage;
///
...
pub fn register(service_name: &str, ctx: &mut zterm_ui::AppContext) {
...
pub fn register_noop(service_name: &str, ctx: &mut zterm_ui::AppContext) {
...
impl zterm_ui::Entity for Model {
    type Event = ();
}

impl zterm_ui::SingletonEntity for Model {}
...
impl AppContextExt for zterm_ui::AppContext {
    fn secure_storage(&self) -> &dyn SecureStorage {
