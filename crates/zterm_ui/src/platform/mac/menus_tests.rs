//! Memory-behavior repros for APP-4154 batch 1.C (zterm_ui-platform-nsstring).
//!
...
use zterm_ui_core::actions::StandardAction;
use zterm_ui_core::keymap::Keystroke;
use zterm_ui_core::platform::menu::{MenuItem, MenuItemPropertyChanges};
