...
/// Returns whether or not the provided adapter is an unsupported Nvidia driver version for zterm_ui
/// to render properly.
...
/// zterm_ui to render properly. Currently, we limit this to "Intel UHD Graphics 620", but we do have
...
/// (Vulkan llvmpipe) adapter that may not work properly with zterm_ui.
