...
use zterm_ui::elements::{Align, ConstrainedBox, ParentElement, Rect, Stack};
use zterm_ui::fonts::FamilyId;
use zterm_ui::SingletonEntity as _;
use zterm_ui::{AppContext, Element, Entity, TypedActionView, View, ViewContext};
...
impl RootView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        let font_family = zterm_ui::fonts::Cache::handle(ctx).update(ctx, |cache, _| {
            cache
