...
use zterm_ui::elements::new_scrollable::AxisConfiguration;
use zterm_ui::elements::new_scrollable::ClippedAxisConfiguration;
use zterm_ui::elements::new_scrollable::DualAxisConfig;
use zterm_ui::elements::new_scrollable::NewScrollableElement;
use zterm_ui::elements::new_scrollable::ScrollableAppearance;
use zterm_ui::elements::new_scrollable::ScrollableAxis;
use zterm_ui::elements::Axis;

use zterm_ui::elements::ChildView;
use zterm_ui::elements::ClippedScrollStateHandle;
use zterm_ui::elements::NewScrollable;
use zterm_ui::elements::Point;
use zterm_ui::elements::ScrollData;
...
impl Element for ScrollableElement {
    ...
    fn after_layout(&mut self, _: &mut zterm_ui::AfterLayoutContext, _: &AppContext) {}

    fn paint(&mut self, origin: Vector2F, ctx: &mut zterm_ui::PaintContext, _app: &AppContext) {
    ...
    fn dispatch_event(
        &mut self,
        _: &zterm_ui::event::DispatchedEvent,
        _: &mut zterm_ui::EventContext,
        _: &AppContext,
    ) -> bool {
        false
    }
...
impl NewScrollableElement for ScrollableElement {
    ...
    fn scroll(&mut self, delta: zterm_ui::units::Pixels, axis: Axis, ctx: &mut zterm_ui::EventContext) {
        match axis {
            Axis::Horizontal => (),
            Axis::Vertical => {
