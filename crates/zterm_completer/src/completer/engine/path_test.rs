...
pub fn test_sorted_paths_relative_to() {
    ...
    assert_eq!(
        zterm_ui::r#async::block_on(sorted_paths_relative_to(
            &ParsedToken::empty(),
...
pub fn test_sorted_directories_relative_to() {
    ...
    assert_eq!(
        zterm_ui::r#async::block_on(sorted_directories_relative_to(
            &ParsedToken::empty(),
            MatchStrategy::CaseInsensitive,
            &ctx
        ))
...
pub fn test_sorted_paths_case_insensitive_ordering() {
    ...
    let suggestions: Vec<String> = zterm_ui::r#async::block_on(sorted_paths_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
