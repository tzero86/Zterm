...
//! `zterm_completer::signatures::CommandSignature`s, as well as `IntoWarpJs` implementations for
...
impl<'js> FromWarpJs<'js> for CommandSignature {
    fn from_zterm_js(
        ...
        let command = Command::from_zterm_js(ctx, object.get("command")?, js_function_registry)?;
        Ok(Self { command })
    }
}
    ...
    fn from_zterm_js(
        ...
        if value.is_object() {
            ...
            if object.contains_key("value")? {
                Ok(ArgumentValue::Suggestion(Suggestion::from_zterm_js(
                    ctx,
                    object.into_value(),
...
impl<'js> FromWarpJs<'js> for TemplateType {
    fn from_zterm_js(
        ...
        let type_string = String::from_zterm_js(ctx, value, js_function_registry)?;
...
impl<'js> FromWarpJs<'js> for GeneratorFn {
    fn from_zterm_js(
        ...
        if value.is_object() {
            ...
            let script = GeneratorScript::from_zterm_js(ctx, value, js_function_registry)?;
...
impl<'js> IntoWarpJs<'js> for GeneratorCompletionContext {
    fn into_zterm_js(self, ctx: rquickjs::Ctx<'js>) -> rquickjs::Result<Value<'js>> {
