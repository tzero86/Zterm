...
/// itself, a process that produces a tree of rendering primitives (in [`zterm_ui`](crate),
...
///
/// ```
/// # use zterm_ui_core::{*, elements::Rect};
///
/// struct MyView {}
///
...
pub trait TypedActionView {
    ...
    /// If your Action enum has tons of actions, and only some of them are meaningful, you can use helper implementations from the `zterm_ui::accessibility` (like `ActionAccessibilityContent::Default()` or `ActionAccessibility_content::from_debug()`).
