...
"User" is not limited to the end user of the Zterm app. It means whoever consumes the surface being designed:
...
15. Theming: table borders, header backgrounds, alternating row shading (if any), and link/code styles all come from the active Zterm theme. No hard-coded colors.
