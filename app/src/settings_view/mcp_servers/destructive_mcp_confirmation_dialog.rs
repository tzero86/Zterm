    ...
    fn from(variant: &DestructiveMCPConfirmationDialogVariant) -> Self {
        match *variant {
            ...
            DestructiveMCPConfirmationDialogVariant::DeleteShared => DestructiveMCPConfirmationDialogDisplayOptions::new(
                ...
                "This will not only delete this MCP server for yourself, but also uninstall and remove this MCP server from Zterm and across all of your teammates' devices.".to_string(),
                "Delete MCP".to_string(),
                "Cancel".to_string(),
            ),
            DestructiveMCPConfirmationDialogVariant::Unshare => DestructiveMCPConfirmationDialogDisplayOptions::new(
                ...
                "This will uninstall and remove this MCP server from Zterm and across all of your teammates' devices.".to_string(),
