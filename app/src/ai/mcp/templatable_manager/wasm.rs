...
impl TemplatableMCPServerManager {
    ...
    /// Updates a TemplatableMCPServer in Zterm Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Gets all TemplatableMCPServers currently in Zterm Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Creates a new TemplatableMCPServer in Zterm Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Deletes a TemplatableMCPServer from Zterm Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
