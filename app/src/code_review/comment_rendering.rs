...
use zterm_core::ui::theme::color::internal_colors::{neutral_1, neutral_2, text_sub};
...
use zterm_ui::{AppContext, Element, EventContext, SingletonEntity, View, ViewContext, ViewHandle};
