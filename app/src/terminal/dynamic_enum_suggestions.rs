use zterm_completer::completer::{CommandOutput, GeneratorContext};
...
fn parse_dynamic_command(output: &CommandOutput) -> anyhow::Result<Vec<String>> {
    match output.status {
        zterm_completer::completer::CommandExitStatus::Success => {
        ...
        zterm_completer::completer::CommandExitStatus::Failure => {
