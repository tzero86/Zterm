...
impl EnableAutoReloadModalBody {
    ...
    fn render_content(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let explanation_text = zterm_ui::elements::FormattedTextElement::new(
        ...
        .register_default_click_handlers_with_action_support(|hyperlink_lens, _event, ctx| {
            match hyperlink_lens {
                ...
                zterm_ui::elements::HyperlinkLens::Action(_action_ref) => {}
            }
        })
        .finish();
...
impl zterm_ui::TypedActionView for EnableAutoReloadModalBody {
    type Action = Action;
...
impl zterm_ui::TypedActionView for EnableAutoReloadModal {
    type Action = ();
}
