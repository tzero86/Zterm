...
const AUTH_OVERRIDE_DESCRIPTION: &str = "It looks like you logged into a Zterm account through a web browser. If you continue, any personal Zterm drive objects and preferences from this anonymous session with be permanently deleted.";
...
impl View for AuthOverrideWarningBody {
    ...
    fn accessibility_contents(&self, _: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new(
            "New login detected",
            "Zterm has detected a new login from a web browser. Press escape to cancel and continue using Zterm without login.",
